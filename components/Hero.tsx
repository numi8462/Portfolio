...
const Hero = () => {
    useGSAP(() => {
        gsap.to('#hello', { opacity: 1, delay: 5 })
        gsap.to('#about', { opacity: 1, delay: 5 })
    })
    ...
    return (
        <div className='pb-20 pt-24'>
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[55vw] sm:max-w-[40vw] md:max-w-[40vw] lg:max-w-[60vw] xl:max-w-[55vw] flex flex-col items-center justify-center'>
                    <h2 className='uppercase tracking-widest text-sm text-center text-white max-w-96'>Next.js를 사용한 반응형 웹페이지</h2>

                    <TextGenerateEffect
                        className='text-start text-xl lg:text-5xl xl:text-6xl'
                        words={`잠깐! <br> 김영호로 삼행시를 준비해봤습니다. <br> 김: 김영호는, <br> 영: 영롱하게 빛나는 아이디어로, <br> 호: 호기심 가득한 개발자입니다`}
                    />
